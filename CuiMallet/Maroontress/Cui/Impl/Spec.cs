namespace Maroontress.Cui.Impl
{
    ...
    public interface Spec
    {
        ...
        /// The queue of the short name options. If this option does not have
        /// an option argument, the queue is not modified. Otherwise, all the
        /// elements of the queue are consumed as the option argument (and
        /// then, the queue gets empty).
        /// </param>
        /// <param name="queue">
        /// The queue of the command line options. If this option has an option
