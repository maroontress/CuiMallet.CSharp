...
{
    /// <summary>
    /// Gets a new <see cref="OptionSchema"/> object with adding an option that
    /// requires an option argument and has the specified short name, the
    /// specified Action, the specified argument name, and the specified
    /// description.
    /// </summary>
    /// <param name="name">
    /// The name of the option. In general, it includes lowercase letters and
    ...
    /// </param>
    /// <param name="action">
    /// The action to be invoked when the specified option and its argument are
    ...
    /// <summary>
    /// Gets a new <see cref="OptionSchema"/> object with adding an option that
    /// has no argument, the specified short name, the specified Action, and
    /// the specified description.
    /// </summary>
    /// <param name="name">
    /// The name of the option. It can include lowercase letters and hyphens.
    /// The name must be unique in this object.
    /// </param>
    /// <param name="shortName">
    /// The short name of the option. The short name must be unique in this
    /// object.
    ...
    /// Gets a new <see cref="OptionSchema"/> object with adding an option that
    /// requires an option argument and has the specified short name, the
    /// specified argument name, and the specified description.
    /// </summary>
    /// <param name="name">
    /// The name of the option. In general, it includes lowercase letters and
    /// hyphens. The name must be unique in this object.
    ...
    /// <summary>
    /// Gets a new <see cref="OptionSchema"/> object with adding an option that
    /// has no argument, the specified short name, and the specified
    /// description.
    /// </summary>
    /// <param name="name">
    /// The name of the option. It can include lowercase letters and hyphens.
